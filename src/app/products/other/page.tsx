...
export default function OtherAgroProductsPage() {
              ...
              <ol className="flex items-center space-x-2">
                ...
                <li>
                  <div className="flex items-center">
                    ...
                    <span className="ml-2 text-green-700" aria-current="page">Other Agro Products</span>
                  </div>
                </li>
              </ol>
            </nav>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="lg:grid lg:grid-cols-2 lg:gap-16">
              ...
              <div className="mt-10 lg:mt-0">
                <h1 className="text-3xl font-extrabold text-gray-900 sm:text-4xl">Other Agro Products</h1>
                <p className="mt-4 text-lg text-gray-600">
                  We offer a wide range of additional agricultural products to meet diverse export requirements. Our portfolio includes various pulses, grains, and specialty crops sourced directly from premium Indian farms.
                </p>

                {/* Specifications */}
                <div className="mt-8 border-t border-b border-gray-200 py-8">
                  <h2 className="text-xl font-bold text-gray-900">Product Range</h2>
                  <ul className="mt-4 space-y-2">
                    <li className="flex items-center">
                      <svg className="h-5 w-5 text-green-500" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor">
                        <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd" />
                      </svg>
                      <span className="ml-2 text-gray-600">Various Pulses (Chana, Moong, Urad, etc.)</span>
                    </li>
                    <li className="flex items-center">
                      <svg className="h-5 w-5 text-green-500" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor">
                        <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd" />
                      </svg>
                      <span className="ml-2 text-gray-600">Specialty Grains (Millet, Quinoa, etc.)</span>
                    </li>
                    <li className="flex items-center">
                      <svg className="h-5 w-5 text-green-500" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor">
                        <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd" />
                      </svg>
                      <span className="ml-2 text-gray-600">Oil Seeds (Mustard, Sesame, etc.)</span>
                    </li>
                    <li className="flex items-center">
                      <svg className="h-5 w-5 text-green-500" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor">
                        <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd" />
                      </svg>
                      <span className="ml-2 text-gray-600">Dried Fruits and Nuts</span>
                    </li>
                    <li className="flex items-center">
                      <svg className="h-5 w-5 text-green-500" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor">
                        <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd" />
                      </svg>
                      <span className="ml-2 text-gray-600">Organic Produce</span>
                    </li>
                  </ul>
                </div>
                ...
                <div className="mt-8">
                  ...
                  <ul className="mt-4 space-y-2">
                    <li className="flex items-center">
                      ...
                      <span className="ml-2 text-gray-600">10kg, 20kg, and 25kg standard packaging</span>
                    </li>
                    <li className="flex items-center">
                      <svg className="h-5 w-5 text-green-500" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor">
                        <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd" />
                    ...
                    <li className="flex items-center">
                      ...
                      <span className="ml-2 text-gray-600">Branded packaging with your company logo</span>
                    </li>
                  </ul>
                </div>
                ...
                <div className="mt-8">
                  ...
                  <ul className="mt-4 space-y-2">
                    <li className="flex items-center">
                      ...
                      <span className="ml-2 text-gray-600">Minimum Order Quantity: Varies by product</span>
                    </li>
                    <li className="flex items-center">
                      <svg className="h-5 w-5 text-green-500" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor">
                        <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd" />
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="mt-12 grid gap-8 md:grid-cols-3">
              <div className="bg-white p-8 rounded-lg shadow">
                ...
                <h3 className="mt-6 text-lg font-medium text-gray-900">Diverse Portfolio</h3>
                <p className="mt-2 text-gray-600">
                  Wide range of agricultural products to meet varied customer requirements.
                </p>
              </div>
              ...
              <div className="bg-white p-8 rounded-lg shadow">
                ...
                <h3 className="mt-6 text-lg font-medium text-gray-900">Flexible Solutions</h3>
                <p className="mt-2 text-gray-600">
                  Customizable packaging and order quantities to suit your business needs.
                </p>
              </div>
              ...
              <form onSubmit={handleSubmit} className="mt-8 space-y-6">
                ...
                <div>
                  ...
                  <textarea 
                    ...
                    onChange={handleInputChange}
                    placeholder="Please specify which products you're interested in and any specific requirements"
                    required 
                    className="mt-1 block w-full border border-gray-300 rounded-md shadow-sm py-2 px-3 focus:outline-none focus:ring-green-500 focus:border-green-500"
                  ></textarea>
                </div>
