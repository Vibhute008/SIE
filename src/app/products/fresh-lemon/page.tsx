...
export default function FreshLemonPage() {
              ...
              <ol className="flex items-center space-x-2">
                ...
                <li>
                  <div className="flex items-center">
                    ...
                    <span className="ml-2 text-green-700" aria-current="page">Fresh Lemons</span>
                  </div>
                </li>
              </ol>
            </nav>
            ...
            <div className="lg:grid lg:grid-cols-2 lg:gap-16">
              ...
              <div>
                <div className="rounded-xl overflow-hidden w-full h-96 bg-gray-100">
                  <Image 
                    src="https://images.unsplash.com/photo-1593587157138-68b77949b3a5?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=600&q=80" 
                    alt="Fresh Lemons" 
                    width={600}
                    height={600}
              ...
              <div className="mt-10 lg:mt-0">
                <h1 className="text-3xl font-extrabold text-gray-900 sm:text-4xl">Fresh Lemons</h1>
                <p className="mt-4 text-lg text-gray-600">
                  Juicy, tangy lemons sourced directly from the orchards of Maharashtra. Our lemons are hand-picked at peak ripeness to ensure optimal flavor, juiciness, and nutritional value. Perfect for culinary applications, beverages, and food processing.
                </p>
                ...
                <div className="mt-8 border-t border-b border-gray-200 py-8">
                  ...
                  <dl className="mt-4 grid grid-cols-1 gap-4 sm:grid-cols-2">
                    <div className="border-b border-gray-100 pb-4">
                      ...
                      <dd className="mt-1 text-sm text-gray-900">08055010</dd>
                    </div>
                    <div className="border-b border-gray-100 pb-4">
                      <dt className="text-sm font-medium text-gray-500">Varieties</dt>
                      <dd className="mt-1 text-sm text-gray-900">Green Lemons, Yellow Lemons</dd>
                    </div>
                    <div className="border-b border-gray-100 pb-4">
                      <dt className="text-sm font-medium text-gray-500">Size</dt>
                      <dd className="mt-1 text-sm text-gray-900">Medium to Large (80-150mm diameter)</dd>
                    </div>
                    <div className="border-b border-gray-100 pb-4">
                      <dt className="text-sm font-medium text-gray-500">Acidity Level</dt>
                      <dd className="mt-1 text-sm text-gray-900">5-7% Citric Acid</dd>
                    </div>
                    <div className="border-b border-gray-100 pb-4">
                      <dt className="text-sm font-medium text-gray-500">Juice Content</dt>
                      <dd className="mt-1 text-sm text-gray-900">40-50%</dd>
                    </div>
                    <div className="border-b border-gray-100 pb-4">
                      <dt className="text-sm font-medium text-gray-500">Shelf Life</dt>
                      <dd className="mt-1 text-sm text-gray-900">2-4 weeks when stored properly</dd>
                    </div>
                  </dl>
                </div>
                ...
                <div className="mt-8">
                  ...
                  <ul className="mt-4 space-y-2">
                    <li className="flex items-center">
                      ...
                      <span className="ml-2 text-gray-600">5kg Corrugated Cartons</span>
                    </li>
                    <li className="flex items-center">
                      <svg className="h-5 w-5 text-green-500" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor">
                        <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd" />
                      </svg>
                      <span className="ml-2 text-gray-600">10kg Wooden Crates with Ventilation</span>
                    </li>
                    <li className="flex items-center">
                      <svg className="h-5 w-5 text-green-500" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor">
                        <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd" />
                      </svg>
                      <span className="ml-2 text-gray-600">20kg Plastic Crates with Ventilation</span>
                    </li>
                    <li className="flex items-center">
                      <svg className="h-5 w-5 text-green-500" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor">
                        <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd" />
                ...
                <div className="mt-8">
                  ...
                  <ul className="mt-4 space-y-2">
                    <li className="flex items-center">
                      ...
                      <span className="ml-2 text-gray-600">Minimum Order Quantity: 5 Metric Tons</span>
                    </li>
                    <li className="flex items-center">
                      <svg className="h-5 w-5 text-green-500" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor">
                        <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd" />
            ...
            <div className="mt-12 grid gap-8 md:grid-cols-3">
              <div className="bg-white p-8 rounded-lg shadow">
                ...
                <p className="mt-2 text-gray-600">
                  Hand-picked at optimal ripeness and carefully sorted to ensure consistent quality and flavor.
                </p>
              </div>
              ...
              <div className="bg-white p-8 rounded-lg shadow">
                ...
                <h3 className="mt-6 text-lg font-medium text-gray-900">High Juice Content</h3>
                <p className="mt-2 text-gray-600">
                  Our lemons contain 40-50% juice, making them ideal for commercial juice production.
                </p>
              </div>
              ...
              <div className="bg-white p-8 rounded-lg shadow">
                ...
                <p className="mt-2 text-gray-600">
                  Direct sourcing from orchards ensures the best prices without compromising on quality.
                </p>
              </div>
            </div>
          </div>
