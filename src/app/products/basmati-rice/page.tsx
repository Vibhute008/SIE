              ...
              <ol className="flex items-center space-x-2">
                ...
                <li>
                  <div className="flex items-center">
                    ...
                    <span className="ml-2 text-green-700" aria-current="page">Basmati Rice</span>
                  </div>
                </li>
              </ol>
            </nav>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="lg:grid lg:grid-cols-2 lg:gap-16">
              ...
              <div className="mt-10 lg:mt-0">
                <h1 className="text-3xl font-extrabold text-gray-900 sm:text-4xl">Basmati Rice</h1>
                <p className="mt-4 text-lg text-gray-600">
                  Premium quality basmati rice varieties sourced directly from the fertile fields of Punjab and Haryana. Our basmati rice is known for its distinctive aroma, slender grains, and superior cooking quality. Available in multiple grades to suit various market preferences.
                </p>
                ...
                <div className="mt-8 border-t border-b border-gray-200 py-8">
                  ...
                  <dl className="mt-4 grid grid-cols-1 gap-4 sm:grid-cols-2">
                    <div className="border-b border-gray-100 pb-4">
                      ...
                      <dd className="mt-1 text-sm text-gray-900">10063010</dd>
                    </div>
                    <div className="border-b border-gray-100 pb-4">
                      <dt className="text-sm font-medium text-gray-500">Varieties</dt>
                      <dd className="mt-1 text-sm text-gray-900">1121, 1509, Pusa</dd>
                    </div>
                    <div className="border-b border-gray-100 pb-4">
                      <dt className="text-sm font-medium text-gray-500">Grain Length</dt>
                      <dd className="mt-1 text-sm text-gray-900">8.0-8.5mm (Extra Long)</dd>
                    </div>
                    <div className="border-b border-gray-100 pb-4">
                      <dt className="text-sm font-medium text-gray-500">Moisture Content</dt>
                      <dd className="mt-1 text-sm text-gray-900">Max 14%</dd>
                    </div>
                    <div className="border-b border-gray-100 pb-4">
                      <dt className="text-sm font-medium text-gray-500">Foreign Matter</dt>
                      <dd className="mt-1 text-sm text-gray-900">Max 0.25%</dd>
                    </div>
                    <div className="border-b border-gray-100 pb-4">
                      <dt className="text-sm font-medium text-gray-500">Broken Grains</dt>
                      <dd className="mt-1 text-sm text-gray-900">Max 2%</dd>
                    </div>
                  </dl>
                </div>
                ...
                <div className="mt-8">
                  ...
                  <ul className="mt-4 space-y-2">
                    <li className="flex items-center">
                      ...
                      <span className="ml-2 text-gray-600">1kg Vacuum Sealed Bags</span>
                    </li>
                    <li className="flex items-center">
                      <svg className="h-5 w-5 text-green-500" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor">
                        <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd" />
                      </svg>
                      <span className="ml-2 text-gray-600">5kg Jute Bags with Polythene Lining</span>
                    </li>
                    <li className="flex items-center">
                      <svg className="h-5 w-5 text-green-500" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor">
                        <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd" />
                ...
                <div className="mt-8">
                  ...
                  <ul className="mt-4 space-y-2">
                    <li className="flex items-center">
                      ...
                      <span className="ml-2 text-gray-600">Minimum Order Quantity: 20 Metric Tons</span>
                    </li>
                    <li className="flex items-center">
                      <svg className="h-5 w-5 text-green-500" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor">
                        <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd" />
            ...
            <div className="mt-12 grid gap-8 md:grid-cols-3">
              <div className="bg-white p-8 rounded-lg shadow">
                ...
                <p className="mt-2 text-gray-600">
                  Sourced from the best basmati growing regions with strict quality control at every stage.
                </p>
              </div>
              ...
              <div className="bg-white p-8 rounded-lg shadow">
                ...
                <h3 className="mt-6 text-lg font-medium text-gray-900">Distinctive Aroma</h3>
                <p className="mt-2 text-gray-600">
                  Naturally aromatic basmati rice that retains its fragrance and flavor after cooking.
                </p>
              </div>
